...
select c.full_name, COUNT(*) as soLuongcongty from candidates c join experiences e on c.candidate_id=e.candidate_id 
group by c.full_name

select * from positions where name like '%Analyst%' and salary >=10000 and salary <=20000